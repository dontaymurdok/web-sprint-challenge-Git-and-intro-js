...
function get20s(array) {
  ...
  if(array[i].years === "1904 - 1989"){
    sArray.push(array[i].name)
    }
...
console.log(`task 6`, addArtist(artists, { id: 20,
  name: "Collin Heffernan", 
  years: "1998 2022",
  genre: "Web Design", 
  nationality: "American",
  bio: "A welder turned software engineer, looking for a 6 figure salary with age apropriate joint usage"}));
...
console.log("task 8 " + artistInfo(artists, "Mexican"));
